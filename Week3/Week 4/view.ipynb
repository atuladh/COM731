{
 "cells": [
  ...
  },
  {
   "attachments": {
    "while-loop.png": {
     "image/png": ""
    }
   },
   "cell_type": "markdown",
   "id": "4d90ddef",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Calculate the summation of a series of positive numbers receive by a user until the user enter nagative number\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "            <li>Using the loop counter in an incorrect mathematical operation inside the loop</li>\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Calculate the summation of five numbers receive by a user\n",
    "total = 0\n",
    "count = 0\n",
    "\n",
    "while count < 5:\n",
  ...
  {
   "cell_type": "markdown",
   "id": "e642d9ec-4214-415a-b246-fea99566bc89",
   "metadata": {},
   "source": [
    "**Fix: updating the loop counter variable inside the loop.**"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "6a20b193-3801-4276-a92a-50f9f76fa668",
   "metadata": {},
   "outputs": [],
   "source": [
    "# Calculate the summation of five numbers receive by a user\n",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "**infinite loop example: Using the loop counter in an incorrect mathematical operation inside the loop**"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "# Incorrect use of the loop counter in a mathematical operation\n",
    "count = 5\n",
    "\n",
    "while count > 0:\n",
    "    print(f\"Loop iteration: {count}\")\n",
    "    count = count * 2  # Incorrect operation: multiplying instead of decrementing"
   ]
  },
  {
   "cell_type": "markdown",
   "id": "a097f0df-3f55-40a9-ab0a-c9e6fb97981b",
   "metadata": {},
   "source": [
    "**Fix:Ensure the loop counter is updated correctly**"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "84bfd978-851a-48bf-953d-1d82182fc20d",
   "metadata": {},
   "outputs": [],
   "source": [
    "count = 5\n",
    "while count > 0:\n",
    "    print(f\"Loop iteration: {count}\")\n",
    "    count = count- 1  # Properly decrementing the counter. This ensures the loop eventually terminates.\n"
   ]
  },
  {
   "cell_type": "markdown",
   "id": "ea43df2f-1c79-4de9-9799-a4de684e83bc",
   "metadata": {},
   "source": [
    "### break"
   ]
  ...
  {
   "cell_type": "markdown",
   "id": "c9d04185-54bb-41e7-b1e0-17f2aa47b7fa",
   "metadata": {},
   "source": [
    "<font size=3>We can intentionally stop a loop using the <span style=\"color: green;\"><b>break</b></span> keyword when a specific condition is met. This allows us to exit the loop immediately, even if the loop’s condition is still true.</font>"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "72e8fe7b-a46d-4969-922d-298fbfe4528e",
   "metadata": {},
   "outputs": [],
   "source": [
    "#Password authentication\n",
    "\n",
    "correct_password = \"secure123\"  # Define the correct password\n",
    "\n",
    "while True:  # Infinite loop to keep asking for the password\n",
    "    password = input(\"Enter your password (or type 'exit' to quit): \")  # Get user input\n",
    "\n",
    "    if password == \"exit\":  # Check if the user wants to exit\n",
    "        print(\"Exiting the program...\")\n",
    "        break  # Stop the loop immediately\n",
    "\n",
    "    if password == correct_password:  # Check if the password is correct\n",
    "        print(\"Access granted!\")\n",
    "        break  # Stop the loop after successful login\n",
    "\n",
    "    print(\"Incorrect password. Try again.\")  # Prompt the user to try again if incorrect\n"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    ...
    "for i in range(1,31):\n",
    "    if (i%2 == 0):\n",
    "        print(f\"The even number in the range of 1-30: {i}\")"
   ]
  },
  {
   "cell_type": "markdown",
